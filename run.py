...
if __name__ == '__main__':
    ...
    net = BayesNet('sachs.bif') # Format and other networks can be found on http://www.bnlearn.com/bnrepository/
    ...
    evidence = {'PKC' : 'LOW'  }  # {, 'Earthquake' : 'True'}
    ...
    try:
        ...
        print('query/evidence not in bayesnet')